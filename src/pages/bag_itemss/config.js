...
export const bagItemsFields = [
  {
    ...
    searchable: false,
    filterable: true, // ده اللي هيظهر select الفلتر فوق الجدول
    sortable: false,
    table_show: false,
    form_show: true,
    options: [], // هتتحقن من الصفحة (bags)
  },
  {
    key: "bag_title",
    label: "الحقيبة",
  ...
  },
  {
    ...
    options: { label: "title", value: "id" }, // هيتبدّل ديناميك من الصفحة برضه
  },
  {
    key: "title",
    label: "Title",
  ...
  },
  {
    ...
    form_show: true,
    options: [
      { label: "ريال", value: "ريال" },
      { label: "دولار", value: "دولار" },
      { label: "جنيه مصري", value: "جنيه مصري" },
    ],
  },
  {
    key: "rating",
